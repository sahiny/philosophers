...
% obstacles: column or row vector (length < numRows x numCols)
%
% OUTPUT
% ws.adjn = Adjacency graph (obstacles are removed)
% ws.adjr = Reduced adjacency graph (obstacle cols and rows deleted)
